 ...
 */
@Controller
@RequestMapping(value = "/bindBankCard/test")
public class TestBindBankCardController implements IControllerHandler {

	private static final Logger LOG = LoggerFactory.getLogger(TestBindBankCardController.class);
