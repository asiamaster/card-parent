...
public interface IRuleFeeService {
	 ...
	 * @return 费用规则中配置的值，未做任何处理
	 */
	BigDecimal getRuleFee(Long amount, RuleFeeBusinessType ruleFeeBusinessType,
	 ...
	 * @return 费用规则中配置的值，未做任何处理
	 */
	BigDecimal getRuleFee(RuleFeeBusinessType ruleFeeBusinessType, SystemSubjectType systemSubjectType);
